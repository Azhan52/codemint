        ...
        >
          ...
          >
            <div id="title" class="w-full py-5 border-b border-gray-800">
              ...
              <h3 class="font-normal text-green-500 text-xl mt-2">
                $9<sup>,99</sup>/month
              </h3>
            </div>
            <div id="content" class="">
              <div id="icon" class="my-5">
                <svg
                  ...
                  class="h-12 w-12 mx-auto fill-stroke text-green-600"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <div id="contain" class="leading-8 mb-10 text-lg font-light">
                ...
                <div id="choose" class="w-full mt-10 px-6">
                  <a
                    href="#"
                    class="w-full block bg-green-900 font-medium text-xl py-4 rounded-xl hover:shadow-lg transition duration-200 ease-in-out hover:bg-green-600 hover:text-white"
                    >Choose</a
                  >
                </div>
              </div>
